            ...
            >
              ...
              <span className={`text-2xl transition-all relative ${isActive ? 'scale-110' : 'opacity-50'}`}>
                ...
                {id === 'gacha' && gachaCoins > 0 && (
                  <span className="absolute -top-1 -right-1 min-w-[16px] h-[16px] bg-yellow-500 rounded-full text-[9px] flex items-center justify-center font-black text-gray-950 px-0.5">
                    {gachaCoins}
                  </span>
                )}
              </span>
