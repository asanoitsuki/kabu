          ...
          {!isSupabaseConfigured ? (
            ...
            <>
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 font-bold py-3.5 rounded-xl transition-all hover:scale-105 active:scale-95"
              >
