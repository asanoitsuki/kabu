...
type AppView = 'game' | 'profile' | 'history' | 'ranking'
...
export default function Home() {
  ...
  return (
    <div className="pb-20">
      ...
      <BottomNav active={activeTab} onTab={handleTab} pendingFriends={pendingFriends} gachaCoins={gachaCoins} />
    </div>
  )
}
